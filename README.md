# vuefire-analytics brenda [![Build Status brenda](https://travis-ci.com/scboesch/vue-deployment-check.svg?branch=master)](https://travis-ci.com/scboesch/vue-deployment-check)
